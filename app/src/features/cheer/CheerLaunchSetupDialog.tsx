...
import { ASAP_JOIN_THRESHOLD, GAME_MOMENT_JOIN_THRESHOLD, gameMomentsForSport, type CheerGameMoment, type CheerLaunchMode } from "./cheerLaunch";
import type { CheerRecord } from "./types";

export function CheerLaunchSetupDialog({ cheer, onCancel, onLaunch }: {
  readonly cheer: CheerRecord;
  readonly onCancel: () => void;
  readonly onLaunch: (mode: CheerLaunchMode, gameMoment: CheerGameMoment | null) => string | null;
}) {
